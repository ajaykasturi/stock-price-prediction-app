              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    src="https://cdn3.vectorstock.com/i/1000x1000/67/87/down-stock-market-business-logo-icon-design-vector-22926787.jpg"
                    alt="Your Company"
                  />
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {isLoggedIn ? (
                  ...
                  <Link
                    as="div"
                    to="/signin"
                    className="relative ml-3 flex items-center bg-white rounded-full text-blue-600 px-3 font-bold hover:bg-gray-100"
                  >
                    Sign In
                  </Link>
                )}
